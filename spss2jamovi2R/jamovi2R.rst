...
`«Learning statistics with jamovi» <https://www.learnstatswithjamovi.com>`__
(mentioned above). The second resource `"R for Psychological Science"
<https://psyr.org>`__ is still under construction and aimed more at someone who
has taken at least one research method class and would like to learn to use the
R programming language in their own work. This site also has a strong focus on
the `tidyverse <https://www.tidyverse.org>`__ methodology of `Hadley Wickham
<http://hadley.nz>`__.
