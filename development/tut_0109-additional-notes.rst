...
(listed in ``DESCRIPTION``), and bundles them into your module. This
...
*all* listed imports in the ``NAMESPACE`` file are loaded whether they
are required or not.
...
This improves start-up time (the delay between a user selecting one of
your analyses, and results appearing for the first time), and can lead
to a significant reduction in the amount of RAM your module uses.
