...
Hopefully you got throw the last section without encountering any errors
...
In this example, our code is only one line of code, so we can be
...
menu to the top right of the jamovi window:

|dev-mode|

With dev mode turned on, we can see the stack trace and see that the
call to ``t.test(c(Inf, 3))`` is responsible for the error.
...
.. |error|     image:: ../_images/dev_tut_0105-debugging-an-analysis-error.png
   :width: 290px
.. |dev-mode|  image:: ../_images/dev_tut_0105-debugging-an-analysis-dev-mode.png
   :width: 294px
.. |stack|     image:: ../_images/dev_tut_0105-debugging-an-analysis-stack.png
   :width: 356px
