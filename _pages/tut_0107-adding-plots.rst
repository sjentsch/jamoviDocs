...
Same as before, we define an item with a `name`, `title` and a `type`;
...
The plot function accepts an argument ``image``, which corresponds to
...
.. |final-plot| image:: ../_images/dev_tut_0107-adding-plots-final.png
   :width: 441px
